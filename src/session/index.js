...
(function() {
  ...
  exports.store = {
    use: function(nameOrStore, options) {
      var MongoStore, RedisStore;

      return sessionStore = nameOrStore === 'redis' ? (RedisStore = require('connect-redis')(connect), new RedisStore(options)) : nameOrStore === 'mongo' ? (MongoStore = require('connect-mongo')(connect), new MongoStore(options)) : nameOrStore;
    },
    get: function() {
      return sessionStore;
    }
